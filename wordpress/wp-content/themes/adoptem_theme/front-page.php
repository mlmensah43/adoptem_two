<?php get_header();?>
    ...
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
      ...
      <div class="col-lg-4">
        ...
        <a class="nav-link" href="<?php echo site_url('/available-pets') ?>"><button type="button" class="btn btn-primary btn-lg px-4 me-md-2 hero-button">Find a pet</button></a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container col-xxl-8 px-4 py-5">
    ...
    <div class="col-lg-6">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-start">
        <a class="nav-link" href="<?php echo site_url('/blog') ?>"><button type="button" class="btn btn-primary btn-lg px-4 me-md-2 hero-button">Learn More</button></a>
        <a class="nav-link" href="<?php echo site_url('/blog') ?>"><button type="button" class="btn btn-primary btn-lg px-4 me-md-2 hero-button">Newsletter</button></a>    
        </div>
      </div>
